...
const children = [
  {
    ...
    __v_skip: true,
    type: 'g',
    props: { 'clip-path': 'url(#clip0_1_196)' },
    key: null,
    ref: null,
    scopeId: null,
    slotScopeIds: null,
    children: [
      ...
      '\n',
      {
        ...
        type: 'path',
        props: {
          d: 'M24.513 24.594C24.513 26.083 24.969 27.463 25.748 28.603C24.47 30.477 22.314 31.712 19.873 31.712C15.943 31.712 12.756 28.525 12.756 24.594C12.756 20.665 15.944 17.48 19.873 17.48C22.314 17.48 24.47 18.712 25.748 20.587C24.969 21.727 24.513 23.107 24.513 24.594Z',
          stroke: 'var(--icon-stroke, white)',
          'stroke-width': 'var(--icon-stroke-width, 3)',
          'stroke-miterlimit': '10',
        },
      ...
      '\n',
      {
        ...
        type: 'path',
        props: {
          d: 'M40.33 49.361H22.226C22.226 49.361 22.226 41.661 22.226 41.61C22.226 38.435 23.489 35.461 25.835 33.68C27.47 32.444 29.46 31.712 31.667 31.712C33.876 31.712 35.893 32.444 37.526 33.679C39.875 35.458 40.539 38.281 40.539 41.456C40.54 41.506 40.33 49.361 40.33 49.361Z',
          stroke: 'var(--icon-stroke, white)',
          'stroke-width': 'var(--icon-stroke-width, 3)',
          'stroke-miterlimit': '10',
        },
      ...
      '\n',
      {
        ...
        type: 'path',
        props: {
          d: 'M52.993 49.361H40.33C40.33 49.361 40.528 41.506 40.528 41.456C40.528 38.281 39.873 35.458 37.527 33.679C39.16 32.442 40.963 31.712 43.172 31.712C48.555 31.712 53.021 36.067 53.021 41.449C53.021 41.503 52.993 49.361 52.993 49.361Z',
          stroke: 'var(--icon-stroke, white)',
          'stroke-width': 'var(--icon-stroke-width, 3)',
          'stroke-miterlimit': '10',
        },
